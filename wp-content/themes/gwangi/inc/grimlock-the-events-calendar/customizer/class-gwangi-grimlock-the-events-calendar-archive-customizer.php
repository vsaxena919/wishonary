<?php
/**
 * Gwangi_Grimlock_The_Events_Calendar_Archive_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Gwangi_Grimlock_The_Events_Calendar_Archive_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	public function add_post_padding_outputs( $outputs ) {
		return array_merge( $outputs, array(
			...
			array(
				'element'       => implode( ',', array(
					'.tribe-events-list:not(.tribe-events-photo) .tribe-events-loop .type-tribe_events .card .card-body',
				) ),
...
return new Gwangi_Grimlock_The_Events_Calendar_Archive_Customizer();
