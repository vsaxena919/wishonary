<?php
/**
 * Gwangi_Grimlock_The_Events_Calendar_Table_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Gwangi_Grimlock_The_Events_Calendar_Table_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
...
return new Gwangi_Grimlock_The_Events_Calendar_Table_Customizer();
