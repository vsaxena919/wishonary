...
if ( ! class_exists( 'Gwangi_BuddyPress' ) ) :
	/**
	 * The main Gwangi_BuddyPress class
	 */
	class Gwangi_BuddyPress {
		/**
		 * Setup class.
		 *
		 * @since 1.0.0
		...
		public function __construct() {
			...
			add_filter( 'bp_before_xprofile_cover_image_settings_parse_args', array( $this, 'change_xprofile_cover_image_settings' ), 10, 1 );
