<?php
/**
 * Gwangi template hooks for Projects by WooThemes.
 *
 * @package gwangi
 */
...
add_action(    'projects_before_main_content', 'gwangi_projects_output_content_wrapper',     10 );
add_action(    'projects_after_main_content',  'gwangi_projects_output_content_wrapper_end', 10 );
...
add_action(    'projects_before_single_project_summary', 'gwangi_projects_template_single_gallery', 40 );
