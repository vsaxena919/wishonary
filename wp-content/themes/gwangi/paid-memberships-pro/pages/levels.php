...
<?php if ( empty( $pmpro_levels ) ): ?>
	<div class="alert alert-info text-center">
		<?php esc_html_e( 'You must first create levels trough the Paid Memberships Pro settings', 'gwangi' ); ?>
	</div>
<?php endif; ?>
...
<div id="pmpro_levels_table" class="pmpro_checkout bg-transparent">
	<div class="row justify-content-center">
		...
		foreach ( $pmpro_levels as $level ) {
			...
			$count++;
			?>
		<div class="col-md-6 col-lg mb-3 <?php if ( 0 === $count % 2 ) { ?>odd<?php } ?><?php if ( $current_level === $level ) { ?> active<?php } ?>">
