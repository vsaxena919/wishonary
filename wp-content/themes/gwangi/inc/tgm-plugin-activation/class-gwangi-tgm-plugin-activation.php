<?php
/**
 * Gwangi_TGM_Plugin_Activation Class
 *
 * @package  gwangi
 * @author   Themosaurus
 * @since    1.0.0
...
if ( ! class_exists( 'Gwangi_TGM_Plugin_Activation' ) ) :
	/**
	 * The Gwangi TGM Plugin Activation class
	 */
	class Gwangi_TGM_Plugin_Activation {
		/**
		 * Setup class.
		 *
		 * @since 1.0.0
		...
		public function register() {
			 ...
			 */
			$plugins = apply_filters( 'gwangi_tgm_plugin_activation_register_plugins', array(
			 ...
			 */
			$config = apply_filters( 'gwangi_tgm_plugin_activation_register_config', array(
				'id'           => 'gwangi',                // Unique ID for hashing notices for multiple instances of TGMPA.
...
return new Gwangi_TGM_Plugin_Activation();
