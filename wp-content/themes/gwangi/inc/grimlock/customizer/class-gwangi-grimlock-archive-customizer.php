<?php
/**
 * Gwangi_Grimlock_Archive_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Gwangi_Grimlock_Archive_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	public function change_defaults( $defaults ) {
		...
		$defaults['archive_custom_header_layout']    = GWANGI_ARCHIVE_CUSTOM_HEADER_LAYOUT;
		...
		$defaults['archive_post_padding']                 = GWANGI_CARD_PADDING;
		$defaults['archive_post_margin']                  = GWANGI_CARD_MARGIN;
		$defaults['archive_post_background_color']        = GWANGI_CARD_BACKGROUND;
		$defaults['archive_post_border_radius']           = GWANGI_CARD_BORDER_RADIUS;
		$defaults['archive_post_thumbnail_border_radius'] = GWANGI_CARD_BORDER_RADIUS;
		$defaults['archive_post_border_width']            = GWANGI_CARD_BORDER_WIDTH;
		$defaults['archive_post_border_color']            = GWANGI_CARD_BORDER_COLOR;

		$defaults['archive_post_border_color'] = GWANGI_CARD_BORDER_COLOR;

		$defaults['archive_post_box_shadow_x_offset']      = GWANGI_BOX_SHADOW_X_OFFSET;
		$defaults['archive_post_box_shadow_y_offset']      = GWANGI_BOX_SHADOW_Y_OFFSET;
		$defaults['archive_post_box_shadow_blur_radius']   = GWANGI_BOX_SHADOW_BLUR_RADIUS;
		$defaults['archive_post_box_shadow_spread_radius'] = GWANGI_BOX_SHADOW_SPREAD_RADIUS;
		$defaults['archive_post_box_shadow_color']         = GWANGI_BOX_SHADOW_COLOR;

		$defaults['archive_post_color']            = GWANGI_CARD_COLOR;
		$defaults['archive_post_title_color']      = GWANGI_CARD_TITLE_COLOR;
		$defaults['archive_post_link_color']       = GWANGI_CARD_LINK_COLOR;
		$defaults['archive_post_link_hover_color'] = GWANGI_CARD_LINK_HOVER_COLOR;

		$defaults['archive_layout']                 = GWANGI_ARCHIVE_LAYOUT;
		$defaults['archive_container_layout']       = GWANGI_ARCHIVE_CONTAINER_LAYOUT;
		$defaults['archive_posts_layout']           = GWANGI_ARCHIVE_POSTS_LAYOUT;
		$defaults['archive_posts_height_equalized'] = GWANGI_ARCHIVE_POSTS_HEIGHT_EQUALIZED;

		$defaults['archive_custom_header_padding_y'] = GWANGI_HEADER_PADDING_Y;
		$defaults['archive_content_padding_y']       = GWANGI_CONTENT_PADDING_Y;
...
return new Gwangi_Grimlock_Archive_Customizer();
